class_name PauseOverlay extends CenterContainer
...
@onready var settings_container := %SettingsContainer as VBoxContainer
@onready var menu_container := %MenuContainer as VBoxContainer
